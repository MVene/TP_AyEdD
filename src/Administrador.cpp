                ...
                while(!router.colaIntercalada.empty()){
                    ...
                    if(paquete.getOrigenRouter()==router.idR){
                        ...
                        */
                        ...
                        cout << "Calculo de ruta para paquete "<< paquete.getId() << " con destino a " << paquete.getDestinoRouter() << "\n";
                    }else{
...
void Administrador::establecerRuta(Router& router, int destino) {
    if (!router.vecinos.empty()) {
        ...
        cout << "Estableciendo ruta para el destino " << destino << " desde el router " << router.idR << "...\n";
        ...
        if (mejorOpcion != -1) {
            ...
            cout << "Mejor opción para el destino " << destino << " es el vecino " << mejorOpcion <<  "\n";
        } else {
